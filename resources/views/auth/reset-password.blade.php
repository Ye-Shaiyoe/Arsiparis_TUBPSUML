...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .info-step-text { color: var(--muted); font-size: 11.5px; }
        .info-step-text.active { color: #bae6fd; font-weight: 500; }
        ...
        .pw-toggle {
            ...
            padding: 2px; font-size: 15px; transition: color .2s;
        }
        ...
        .back-row span { color: var(--muted); font-size: 12.5px; }
        .back-link {
        ...
        @media (max-width: 640px) {
            ...
            .brand-sub, .divider-line, .info-box, .status-pill { display: none; }
...
<body>
    ...
    <div class="scene">
        ...
        <div class="panel-left">
            ...
            <!-- Steps guide -->
            <div class="info-box">
                <div class="info-box-label">Langkah Reset Sandi</div>
                <div class="info-step">
                    <div class="info-dot">1</div>
                    <div class="info-step-text">Cek email Anda</div>
                </div>
                <div class="info-step">
                    <div class="info-dot active">2</div>
                    <div class="info-step-text active">Buat kata sandi baru</div>
                </div>
                <div class="info-step">
                    <div class="info-dot">3</div>
                    <div class="info-step-text">Login ke sistem</div>
                </div>
            </div>
        ...
        <div class="panel-right">
            ...
            <div class="form-heading">
                Atur Ulang <span>Kata Sandi</span>
            </div>
            <div class="form-sub">Buat kata sandi baru yang kuat untuk akun Anda</div>
            ...
            <form method="POST" action="{{ route('password.store') }}">
                ...
                <div class="field-group">
                    ...
                    <div class="input-wrap">
                        ...
                        <button type="button" class="pw-toggle" onclick="togglePw('password','pwIcon1')" tabindex="-1" aria-label="Tampilkan kata sandi">
                ...
                <div class="field-group">
                    ...
                    <div class="input-wrap">
                        ...
                        <button type="button" class="pw-toggle" onclick="togglePw('password_confirmation','pwIcon2')" tabindex="-1" aria-label="Tampilkan konfirmasi">
